...
menu_items = ("Burger Budgie Special", "Cheese Burger", "Vegetarian Burger",
              "Big Budgie Burger", "Itsy-bitsy Burger",
              "Spiced chicken burger", "Bacon-beef burger",
              "Mega beef stacker burger", "Beef stacker burger",
              "Seafood supreme burger", "BBQ Eternal burger",
              "Supreme stacker burger")
menu_prices = (6, 4.5, 4.5, 5, 3, 5, 5, 6, 5, 5, 5, 6)
# Creates the two list for what the user orders
order_items = []
order_prices = []

# Validates input to make sure it is between a low and high
...
def not_valid_alphaonly(question):  # Created function and brings in parameter question
    ...
    while not valid:  # Sets up while loop
        ...
        if answer != "" and any(x.isnumeric() for x in answer) is False:  # If statement , First part makes sure answer variable is not blank, secound part checks each individual character in the variable answer for any unwanted numbers.
